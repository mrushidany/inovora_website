...
<head>
	...
	<title>Light - Coming Soon HTML5 Responsive Template</title>
	...
	<link rel="stylesheet" href="css/solidcolor-4.css" type="text/css">
</head>
...
<body>
	...
	<div id="buy-now-fixed-box" class="buy-now-fixed-box">		
		<div class="btn-holder">
			<a href="../../item/light-coming-soon-html5-responsive-template/20518804.html?ref=mgscoder" class="btn btn-primary btn-lg" target="_blank">Buy Now</a>
		</div>		
	</div>
